 ...
 */
public class App {
    public void run(String[] args) throws IOException, ClassNotFoundException, IllegalAccessException, InstantiationException, NoSuchMethodException, InvocationTargetException, URISyntaxException {
...
//        }
    ...
    public static String findJar() throws URISyntaxException {
        File f = new File(AvroInputFormat.class.getProtectionDomain()
                .getCodeSource().getLocation().toURI());
        File f1 = new File(AvroInputFormat.class.getProtectionDomain()
                .getCodeSource().getLocation().toURI());
